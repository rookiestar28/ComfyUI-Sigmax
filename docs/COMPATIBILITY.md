...
- Ownership/domain preflight, immutable request/result structures, and non-terminal base-grid
  builders exist, but no complete sigma scheduler or full sampler is exposed.
