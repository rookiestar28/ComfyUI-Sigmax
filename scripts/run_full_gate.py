...
def _inspect_wheel(wheel: Path) -> None:
    ...
    required = {
        ...
        "comfyui_sigmax/nodes/minimax_h3_sigma_scheduler.py",
        "comfyui_sigmax/nodes/sd3_sigma_scheduler.py",
        "comfyui_sigmax/nodes/aura_flow_sigma_scheduler.py",
        "comfyui_sigmax/nodes/lumina2_sigma_scheduler.py",
        "comfyui_sigmax/nodes/hunyuan_image21_sigma_scheduler.py",
        ...
        "comfyui_sigmax/profiles/minimax_h3.py",
        "comfyui_sigmax/profiles/sd3.py",
        "comfyui_sigmax/profiles/aura_flow.py",
        "comfyui_sigmax/profiles/lumina2.py",
        "comfyui_sigmax/profiles/hunyuan_image21.py",
